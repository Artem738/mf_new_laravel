...
return [
    'screens' => [
        ...
        'hands_free' => [
            'text' => "<b>Hands-Free Mode</b> 🎙️\n\nIn Mindflasher, you can study without touching the screen at all—perfect for walks, cooking, or driving.\n\n⚙️ <b>How to start and configure:</b>\n1️⃣ <b>Launch:</b> Make a <b>long press</b> on any deck in the application.\n2️⃣ <b>Open in Browser:</b> Since Telegram constantly prompts for microphone permissions inside its in-app browser, we recommend using a regular web browser (Chrome / Safari). Simply tap the <b>\"Copy Web Link\"</b> button inside the app and open it in your browser.\n3️⃣ <b>Noise Calibration:</b> On the voice lesson start screen, there is a sensitivity slider. You can calibrate it so that background noise (like car engine sounds) won't interfere with voice detection.\n\nOnce set up, the Hands-Free mode works flawlessly, listening to your answers and evaluating pronunciation automatically using AI!",
        ],
    ],
    'buttons' => [

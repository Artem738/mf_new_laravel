...
return [
    ...
    'cards' => [
        ...
        ['q' => '___ ___ ___ ___ ___ (Не мне судить / Я не вправе), but I think you are wrong.', 'a' => "✅ **Far be it from me to**\n\n*💡 Правило: Очень вежливый (и часто ироничный) способ высказать критику.*"],
        ...
        ['q' => '___ ___ (Внутрь вошел) the manager.', 'a' => "✅ **In came**\n\n*💡 Правило: Fronting. Если предложение начинается с предлога направления (In, Out, Down, Up), подлежащее и сказуемое меняются местами для драматического эффекта.*"],
        ['q' => 'Such ___ ___ ___ (настолько силой была буря) that trees were uprooted.', 'a' => "✅ **was the storm\'s strength**\n\n*💡 Правило: Инверсия с Such (Such + was + подлежащее).*"],
        ...
        ['q' => 'It is ___ ___ (широко признано) that climate change is real.', 'a' => "✅ **widely acknowledged**\n\n*💡 Правило: Типичная C2 конструкция для академических эссе.*"],
        ['q' => 'The artifacts are ___ ___ ___ ___ (считается, что были украдены) in 1912.', 'a' => "✅ **thought to have been stolen**\n\n*💡 Правило: Сложный перфектно-пассивный инфинитив (to have been + V3).*"],
        ['q' => 'The virus is ___ ___ ___ (полагают, возникло) in bats.', 'a' => "✅ **believed to have originated**\n\n*💡 Правило: Пассив + Perfect Infinitive для событий в прошлом.*"],

        // --- Advanced Connectors & Prepositions ---
        ['q' => 'He agreed to help, ___ (в той мере, в какой) it didn\'t cost him money.', 'a' => "✅ **insofar as / in so far as**\n\n*💡 Правило: Ограничительный союз (насколько, в той степени, в какой).*"],
        ['q' => 'They created a system ___ (посредством которой) everyone can vote.', 'a' => "✅ **whereby**\n\n*💡 Правило: Whereby = by which (с помощью/посредством которого).*"],
        ...
        ['q' => 'He objected ___ ___ ___ (к тому, чтобы с ним обращались) like a child.', 'a' => "✅ **to being treated**\n\n*💡 Правило: object to + V-ing. Пассивный герундий (being V3).*"],
        ['q' => 'I resent ___ ___ ___ (что она задает) such personal questions.', 'a' => "✅ **her asking**\n\n*💡 Правило: В формальном английском перед герундием используется притяжательное местоимение (her/his/their), а не объектное (her/him/them).*"],
        ['q' => '___ ___ ___ ___ (Рассматриваемый с этой точки зрения), the problem is trivial.', 'a' => "✅ **Seen from this perspective**\n\n*💡 Правило: Past Participle (Seen/Viewed) заменяет \"If it is seen...\".*"],
        ['q' => '___ ___ ___ (Не будучи проинформированным), he made a huge mistake.', 'a' => "✅ **Not having been informed**\n\n*💡 Правило: Отрицание в Perfect Passive Participle.*"],

        // --- Advanced Conditionals / Reduced Conditionals ---
        ['q' => '___ ___ ___ (Если вы случайно) see him, tell him to call me.', 'a' => "✅ **Should you happen to**\n\n*💡 Правило: Инверсия 1-го типа с happen to (вероятность очень мала).*"],
        ['q' => '___ ___ ___ (Если бы они сделали) an offer, I would accept it.', 'a' => "✅ **Were they to make**\n\n*💡 Правило: Инверсия 2-го типа для гипотетического будущего.*"],
        ...
        ['q' => 'I would ___ (предпочел бы) you hadn\'t told her the truth.', 'a' => "✅ **sooner / rather**\n\n*💡 Правило: would sooner / would rather + Past Perfect для сожаления о чужом действии в прошлом.*"],
        ['q' => 'He acted ___ ___ / ___ ___ (как будто) he had seen a ghost.', 'a' => "✅ **as if / as though**\n\n*💡 Правило: После as if / as though используем Past Perfect для нереальных ситуаций (он не видел призрака на самом деле).*"],

        // --- Tricky Pronouns, Modifiers & Litotes (Двойное отрицание) ---
        ['q' => 'She has written three books, ___ ___ ___ (ни одна из которых) was successful.', 'a' => "✅ **none of which**\n\n*💡 Правило: none / some / all / few + of which/whom.*"],
        ['q' => 'He has a lot of friends, ___ ___ ___ (многие из которых) are artists.', 'a' => "✅ **many of whom**\n\n*💡 Правило: Для людей используем whom, а не who (после предлога of).*"],
        ['q' => 'The decision was ___ ___ ___ (не совсем беспроблемным).', 'a' => "✅ **not entirely unproblematic**\n\n*💡 Правило: Litotes (Литота) — утверждение через двойное отрицание для смягчения или придания академичности стилю.*"],
        ['q' => 'His performance was ___ ___ ___ (отнюдь не выдающимся).', 'a' => "✅ **not unappealing / not unimpressive**\n\n*💡 Правило: Двойное отрицание используется для нюанса \"довольно неплохой\".*"],

        // --- Ellipsis & Substitution (Опущение слов) ---
        ['q' => 'She told me to resign, and ___ ___ ___ (что я и сделал)!', 'a' => "✅ **resign I did / do it I did**\n\n*💡 Правило: Эмфатическое повторение глагола (Substitution and Ellipsis).*"],
